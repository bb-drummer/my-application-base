...
/**
 * @coversDefaultClass \Application\Controller\SystemController
 */
class SystemControllerTest extends ActionControllerTestCase
{
    ...
    public function setupController()
    {
        ...
        $this->setController(new SystemController( $serviceLocator ));
