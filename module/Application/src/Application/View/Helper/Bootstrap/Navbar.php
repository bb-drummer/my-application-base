 ...
 * , AbstractHelper
 */
//class Navbar extends AbstractHelper implements \Zend\ServiceManager\ServiceLocatorAwareInterface, \Zend\View\Helper\Navigation\HelperInterface
class Navbar extends \Application\View\Helper\Navigation\Menu
{
     ...
     * @var string
     */
    protected $iconPrefixClass = 'glyphicon glyphicon-'; // 'icon-';
